...
export default ({ size = 40, thickness = 8 }) => (
  <Wrapper>
    <svg className="spinner" width={`${size}px`} height={`${size}px`} viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
      <circle className="path" fill="none" strokeWidth={`${thickness}px`} strokeLinecap="round" cx="50" cy="50" r={50 - thickness - 1} />
    </svg>
  </Wrapper>
);
